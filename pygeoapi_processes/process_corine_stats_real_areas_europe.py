...
'''
# Input: Zipped shapefile (and COG layers)
# TESTED 2026-02-19
curl -X POST https://${PYSERVER}/processes/corine-stats-real-areas-europe/execution \
...
# Input: GeoJSON file (reprojected to EPSG::3067) (and COG layers)
# TESTED 2026-02-19
curl -X POST https://${PYSERVER}/processes/corine-stats-real-areas-europe/execution \
--header 'Content-Type: application/json' \
--data '{
...
class SykeCorineEuropeProcessor(BaseProcessor):
    ...
    def __init__(self, processor_def):
        ...
        self.script_name = 'run_corine_europe_stats_areas.py'
    ...
    def __repr__(self):
        return f'<SykeCorineEuropeProcessor> {self.name}'
