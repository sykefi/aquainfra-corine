...
try:
    import aquainfra_corine.corine_europe_stats_areas as corine_europe_stats_areas
    LOGGER.warning('run: Cannot import "aquainfra_corine.corine_europe_stats_areas"...')
except ModuleNotFoundError as e:
    LOGGER.warning('run: Importing "corine_europe_stats_areas"...')
    import corine_europe_stats_areas
    LOGGER.warning('run: Importing "corine_europe_stats_areas"... DONE.')
...
def main():
    ...
    #output_path_in_docker = output_dir.rstrip('/')+'/'+output_name
    ...
    mapping, results = corine_europe_stats_areas.corine_stats_real_areas(
        input_polygons_path,
        input_path_rasters,
        input_path_headers,
        output_path,
